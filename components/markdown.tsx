    ...
    <div className={cn("markdown text-sm leading-relaxed", className)}>
      <ReactMarkdown
        ...
        components={{
          ...
          h1: (props: any) => (
            <h1 {...(props as any)} className={cn("mt-3 mb-2 text-base font-semibold", (props as any).className)} />
          ),
          h2: (props: any) => (
            <h2 {...(props as any)} className={cn("mt-3 mb-1.5 text-[0.95rem] font-semibold", (props as any).className)} />
          ),
          h3: (props: any) => (
            <h3 {...(props as any)} className={cn("mt-2.5 mb-1 text-sm font-medium", (props as any).className)} />
          ),
          p: (props: any) => (
            <p {...(props as any)} className={cn("my-2", (props as any).className)} />
          ),
          ul: (props: any) => (
            <ul
              {...(props as any)}
          ...
          li: (props: any) => (
            <li {...(props as any)} className={cn("my-0.5", (props as any).className)} />
          ),
          ...
          td: (props: any) => (
            <td
              {...(props as any)}
              className={cn("border px-3 py-2 text-foreground/90", (props as any).className)}
            />
          ),
          code: (props: any) => {
          ...
          pre: (props: any) => {
            ...
            // @ts-ignore - props.children is the <code> element from react-markdown
