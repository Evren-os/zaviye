import { GitBranchIcon, User, VolumeXIcon, ZapIcon } from "lucide-react";
import { systemPrompts } from "@/lib/system-prompts";
import type { Persona } from "@/lib/types";

/**
 * Default personas shipped with the application
 * These personas are always available and can be customized by users
 */
...
/**
 * Default icon for custom personas
 */
export const CUSTOM_PERSONA_ICON = User;
