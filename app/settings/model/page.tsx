...
export default function ModelSettingsPage() {
	const { globalModel, setGlobalModel, getRawCustomPersonas, updatePersona } =
		usePersonas();
			...
			<div className="space-y-6">
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Set the default AI model for all personas. This can be overridden
							on a per-persona basis from the Persona Hub.
						</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="w-full max-w-sm">
							<Select
								value={globalModel}
								onValueChange={(v) => handleModelChange(v as ModelId)}
							>
								<SelectTrigger>
			...
			<AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							You have custom AI models set for one or more personas. Changing
							the global default will reset all of them. Do you want to proceed?
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
